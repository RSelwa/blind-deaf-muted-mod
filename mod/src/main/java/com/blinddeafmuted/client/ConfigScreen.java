...
public final class ConfigScreen extends Screen {
    ...
    private enum Style { HZ, GAIN, BLOCKS, MINUTES, PERCENT, SECONDS, HFGAIN, HEADER, BOOLEAN }
    ...
    private static final Spec[] SPECS = {
            // ---- DEAF: how a deaf player hears voices (0-1) + the game world (6, 17-19) ----
            ...
            new Spec(17, 0.000000000001f, 0.02f, Style.HFGAIN, "config.blind-deaf-muted.deafMuffleGainHf", Category.DEAF),
            new Spec(18, 0f, 1f, Style.GAIN, "config.blind-deaf-muted.deafMuffleGain", Category.DEAF),
            new Spec(19, 2f, 64f, Style.BLOCKS, "config.blind-deaf-muted.deafMuffleRange", Category.DEAF),
            ...
            new Spec(14, 5f, 300f, Style.SECONDS, "config.blind-deaf-muted.reliefDurationSeconds", Category.RELIEF),
            new Spec(-1, 0, 0, Style.HEADER, "config.blind-deaf-muted.cat.deaf", Category.RELIEF),
            new Spec(20, 0f, 2f, Style.GAIN, "config.blind-deaf-muted.deafReliefTinnitusVolume", Category.RELIEF),
            new Spec(21, 0.1f, 5f, Style.SECONDS, "config.blind-deaf-muted.deafReliefTinnitusFadeSeconds", Category.RELIEF),
            new Spec(22, 1f, 30f, Style.SECONDS, "config.blind-deaf-muted.deafReliefTinnitusDurationSeconds", Category.RELIEF),
            new Spec(23, 1f, 60f, Style.SECONDS, "config.blind-deaf-muted.deafReliefVoicesIntervalMinSeconds", Category.RELIEF),
            new Spec(24, 1f, 60f, Style.SECONDS, "config.blind-deaf-muted.deafReliefVoicesIntervalMaxSeconds", Category.RELIEF),
            new Spec(25, 2f, 64f, Style.BLOCKS, "config.blind-deaf-muted.deafReliefVoicesNearbyRangeBlocks", Category.RELIEF),
            new Spec(-1, 0, 0, Style.HEADER, "config.blind-deaf-muted.cat.muted", Category.RELIEF),
            new Spec(26, 0.5f, 60f, Style.SECONDS, "config.blind-deaf-muted.mutedReliefNoiseIntervalMinSeconds", Category.RELIEF),
            new Spec(27, 0.5f, 60f, Style.SECONDS, "config.blind-deaf-muted.mutedReliefNoiseIntervalMaxSeconds", Category.RELIEF),
            new Spec(28, 0f, 2f, Style.GAIN, "config.blind-deaf-muted.mutedReliefNoiseVolume", Category.RELIEF),
            new Spec(-1, 0, 0, Style.HEADER, "config.blind-deaf-muted.cat.blind", Category.RELIEF),
            new Spec(29, 0f, 1f, Style.PERCENT, "config.blind-deaf-muted.blindReliefNauseaStrength", Category.RELIEF),
            // ---- OTHER: events, randomizer, megaphone timing ----
            new Spec(7, 0.0f, 1.0f, Style.BOOLEAN, "config.blind-deaf-muted.eventAutoRerollEnabled", Category.OTHER),
            new Spec(8, 0.5f, 30f, Style.MINUTES, "config.blind-deaf-muted.eventMinMinutes", Category.OTHER),
            new Spec(9, 0.5f, 60f, Style.MINUTES, "config.blind-deaf-muted.eventMaxMinutes", Category.OTHER),
